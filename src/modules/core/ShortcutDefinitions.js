...
export const SHORTCUTS = {
    GLOBAL: [
        ...
        { key: '?', ctrl: true, shift: true, cmd: 'app:shortcut-guide', description: 'Shortcut Guide' },
        { key: '/', ctrl: true, cmd: 'app:shortcut-guide', description: 'Shortcut Guide' },
        ...
        { key: 'm', ctrl: true, alt: true, cmd: 'app:new-note', description: 'New Quick Note' },
        { key: 'c', ctrl: true, alt: true, cmd: 'app:toggle-ai-chat', description: 'Toggle AI Chat' },
